  ...
  lessons: [
    {
      ...
      dialogue: [
        ...
        { who: "A", es: "Oye, y para el próximo viaje, ¿ya pensaron adónde ir? Deberíais elegir un lugar con una cocina mejor equipada.", pt: "Ei, e para a próxima viagem, vocês já pensaram para onde ir? Vocês deveriam escolher um lugar com uma cozinha melhor equipada." },
        { who: "B", es: "Sí, estamos pensando en alquilar un apartamento en la ciudad la próxima vez, así tendremos de todo cerca.", pt: "Sim, estamos pensando em alugar um apartamento na cidade da próxima vez, assim teremos tudo por perto." },
        { who: "A", es: "Buena idea. Y si necesitan recomendaciones de restaurantes o de sitios para comprar buenos utensilios, avísenme.", pt: "Boa ideia. E se precisarem de recomendações de restaurantes ou de lugares para comprar bons utensílios, me avisem." },
        { who: "B", es: "¡Claro que sí! Muchas gracias por el ofrecimiento. Te tomaremos la palabra.", pt: "Claro que sim! Muito obrigado pela oferta. Vamos te cobrar isso." }
      ],
      vocabulary: [
        {
    ...
    },
    {
      ...
      dialogue: [
        { who: "text", es: "María, habiendo sido invitada a la boda de su mejor amiga, fue rápidamente a una tienda de ropas a comprar un vestido para la fiesta. Ella fue a una tienda que se llama Vivir Bella y luego de haber entrado, vio el vestido más perfecto que había visto en su vida. Un vestido negro con dorado, largo y brillante. María luego le preguntó a la dependiente si tenía su talla, y por suerte, le dijo que sí. Ella fue al probador, lo probó y en el mismo momento se enamoró. Habiendo probado el vestido, ya fue a la caja y lo compró pagando con tarjeta de crédito en cuotas. Después de todo, era un vestido muy caro. La dependiente, viendo lo contenta que estaba María, le ofreció además un descuento en unos zapatos a juego que combinaban perfectamente con el vestido, y María no lo pensó dos veces antes de aceptarlo. También aprovechó para comprar un bolso pequeño y un collar dorado, habiendo decidido que quería estar impecable de la cabeza a los pies. Habiendo salido de la tienda, fue a pedir un turno con su peluquero y su manicura para estar linda en la boda de su amiga, y de camino a casa ya iba pensando en qué peinado le quedaría mejor con un vestido tan elegante.", pt: "Maria, tendo sido convidada para o casamento da melhor amiga dela, foi rapidamente a uma loja de roupas comprar um vestido para a festa. Ela foi a uma loja chamada Vivir Bella e, depois de ter entrado, viu o vestido mais perfeito que já tinha visto na vida. Um vestido preto com dourado, longo e brilhante. Maria então perguntou à atendente se tinha o tamanho dela, e por sorte, ela disse que sim. Foi ao provador, experimentou o vestido e no mesmo momento se apaixonou. Tendo experimentado o vestido, foi até o caixa e o comprou pagando com cartão de crédito parcelado. Afinal, era um vestido muito caro. A atendente, vendo o quanto Maria estava feliz, ofereceu também um desconto em uns sapatos combinando que ficavam perfeitos com o vestido, e Maria não pensou duas vezes antes de aceitar. Também aproveitou para comprar uma bolsa pequena e um colar dourado, tendo decidido que queria estar impecável da cabeça aos pés. Tendo saído da loja, foi marcar um horário com o cabeleireiro e a manicure para estar linda no casamento da amiga, e no caminho para casa já ia pensando em qual penteado ficaria melhor com um vestido tão elegante." }
      ],
      vocabulary: [
        {
          category: "Comercio",
    ...
    },
    {
      ...
      dialogue: [
        ...
        { who: "A", es: "Ah, espere. Antes de irse, ¿le interesaría abrir una cuenta de ahorros con nosotros? Ofrecemos una tasa de interés muy competitiva este mes.", pt: "Ah, espere. Antes de ir embora, a senhora teria interesse em abrir uma conta poupança conosco? Estamos oferecendo uma taxa de juros bem competitiva este mês." },
        { who: "B", es: "La verdad es que sí me interesa. ¿Podría explicarme un poco más sobre las condiciones?", pt: "Na verdade, sim, tenho interesse. Poderia me explicar um pouco mais sobre as condições?" },
        { who: "A", es: "Por supuesto. No hay comisión de mantenimiento y el rendimiento se paga mensualmente directamente en su cuenta.", pt: "Claro. Não há taxa de manutenção e o rendimento é pago mensalmente diretamente na conta da senhora." },
        { who: "B", es: "Me parece muy interesante. Voy a pensarlo con calma y regreso la próxima semana para abrirla.", pt: "Acho bem interessante. Vou pensar com calma e volto na próxima semana para abri-la." },
    ...
    },
    {
      ...
      dialogue: [
        ...
        { who: "A", es: "¡Perfecto, señor! ¡Estoy seguro de que no se arrepentirá! ¿Y prefiere pagar todo de contado o financiado en varias cuotas?", pt: "Perfeito, senhor! Tenho certeza de que não vai se arrepender! E o senhor prefere pagar tudo à vista ou financiado em várias parcelas?" },
        { who: "B", es: "Creo que voy a financiarlo en veinticuatro cuotas, así no comprometo todos mis ahorros de una vez.", pt: "Acho que vou financiar em vinte e quatro parcelas, assim não comprometo todas as minhas economias de uma vez." },
        { who: "A", es: "Excelente decisión. Voy a preparar el contrato ahora mismo y se lo envío por correo electrónico para que lo revise con calma.", pt: "Excelente decisão. Vou preparar o contrato agora mesmo e enviar por e-mail para o senhor revisar com calma." },
        { who: "B", es: "Perfecto, muchas gracias por toda la paciencia durante este proceso.", pt: "Perfeito, muito obrigado por toda a paciência durante esse processo." }
      ],
      vocabulary: [
        {
    ...
    },
    {
      ...
      dialogue: [
        { who: "text", es: "Montevideo, Uruguay — 28, diciembre, 2024. Estimado Sr. Saavedra: Le escribo para agradecerle por haberme contestado pronto y haber resuelto nuestros problemas con el sistema. Le envío también adjuntos los datos solicitados referentes al viaje que vamos a hacer y los días en los cuales no vamos a estar en la oficina para que usted mande a alguien la semana siguiente para averiguar qué tenemos que hacer para cambiar los sistemas. Aprovecho también para confirmar que la reunión de seguimiento quedará agendada para el 15 de enero, a las diez de la mañana, hora de Montevideo, y que estaremos disponibles por correo electrónico durante todo el periodo de viaje en caso de cualquier urgencia. ¡Les deseamos a usted y a su equipo un feliz año nuevo! Estamos a su servicio para cualquier pregunta. Saludos, Luciana Álvez — Equipo de ventas — Su mejor Internet. P.D.: Adjunto también el informe final del trimestre, tal como lo habíamos acordado en nuestra última llamada.", pt: "Montevidéu, Uruguai — 28 de dezembro de 2024. Prezado Sr. Saavedra: Escrevo para agradecer por ter me respondido rapidamente e ter resolvido nossos problemas com o sistema. Envio também em anexo os dados solicitados referentes à viagem que vamos fazer e os dias em que não estaremos no escritório, para que o senhor envie alguém na semana seguinte para verificar o que precisamos fazer para trocar os sistemas. Aproveito também para confirmar que a reunião de acompanhamento ficará agendada para o dia 15 de janeiro, às dez da manhã, horário de Montevidéu, e que estaremos disponíveis por e-mail durante todo o período da viagem em caso de qualquer urgência. Desejamos a você e à sua equipe um feliz ano novo! Estamos à disposição para qualquer dúvida. Saudações, Luciana Álvez — Equipe de vendas — Sua melhor Internet. P.S.: Anexo também o relatório final do trimestre, conforme combinamos na nossa última ligação." }
      ],
      vocabulary: [
        {
    ...
    },
    {
      ...
      dialogue: [
        { who: "text", es: "Evandro luego que hubo empezado sus clases en España cuando estaba de intercambio en 2002, tuvo algunos problemas en la escuela donde estaba estudiando. Sus compañeros de clase eran muy inteligentes y lo recibieron muy bien desde el primer día, pero él estaba teniendo algunos problemas con el idioma y no podía comunicarse muy bien con sus nuevos amigos. Apenas hubo hablado con su profesora sobre todos sus problemas, tuvo una buena idea. Perder la vergüenza y tratar de practicar con sus colegas, y realmente hacer todo lo que podía para aprender mucho mientras estaba en este viaje inolvidable. Empezó a salir con todos de su clase, ir a las fiestas, a restaurantes, ver la tele, películas en español, escuchar temas que le gustaban y hacer de todo. También se apuntó a un club de debate de la universidad, donde apenas hubo participado en la primera reunión, ya se sintió mucho más cómodo hablando en público delante de desconocidos. Apenas hubo pasado un mes de mucho esfuerzo, Evandro ya se dio cuenta de que estaba hablando mucho mejor y ya podía comunicarse bien con sus amigos, teniendo de esta forma, un intercambio mejor imposible. Al final del año, cuando tuvo que regresar a Brasil, lloró de tristeza al despedirse de todos los amigos que había hecho durante ese tiempo.", pt: "Evandro, assim que começou suas aulas na Espanha quando estava de intercâmbio em 2002, teve alguns problemas na escola onde estava estudando. Seus colegas de classe eram muito inteligentes e o receberam muito bem desde o primeiro dia, mas ele estava tendo alguns problemas com o idioma e não conseguia se comunicar muito bem com seus novos amigos. Assim que conversou com sua professora sobre todos os seus problemas, teve uma boa ideia. Perder a vergonha e tentar praticar com seus colegas, e realmente fazer tudo o que podia para aprender bastante enquanto estava nessa viagem inesquecível. Começou a sair com todos da turma, ir a festas, a restaurantes, ver TV, filmes em espanhol, ouvir músicas de que gostava e fazer de tudo. Também se inscreveu em um clube de debate da universidade, onde, assim que participou da primeira reunião, já se sentiu muito mais confortável falando em público diante de desconhecidos. Assim que se passou um mês de muito esforço, Evandro já percebeu que estava falando muito melhor e já conseguia se comunicar bem com seus amigos, tendo, dessa forma, um intercâmbio impossível de ser melhor. No final do ano, quando teve que voltar para o Brasil, chorou de tristeza ao se despedir de todos os amigos que tinha feito durante esse tempo." }
      ],
      vocabulary: [
        {
    ...
    },
    {
      ...
      dialogue: [
        { who: "text", es: "12 consejos para hacer un currículum atractivo: 1 - Sea honesto. 2 - Haga un currículo de 1 página. 3 - Añada sus datos básicos. 4 - Especifique el nivel de sus habilidades. 5 - Especifique a cada puesto ocupado, las misiones y las tareas realizadas. 6 - Resalte sus experiencias y habilidades. 7 - Construya su CV en función del puesto al que aspira. 8 - Utilice un CV cronológico. 9 - Indique sus informaciones de contacto. 10 - Añada sus redes sociales. 11 - Revise cuidadosamente la ortografía y la gramática antes de enviarlo, ya que un solo error puede dar una mala impresión al reclutador. 12 - Personalice el currículum para cada oferta de empleo, destacando las palabras clave que aparecen en el anuncio del puesto.", pt: "12 dicas para fazer um currículo atraente: 1 - Seja honesto. 2 - Faça um currículo de 1 página. 3 - Adicione seus dados básicos. 4 - Especifique o nível das suas habilidades. 5 - Especifique, para cada cargo ocupado, as missões e as tarefas realizadas. 6 - Destaque suas experiências e habilidades. 7 - Construa seu currículo em função do cargo ao qual você aspira. 8 - Utilize um currículo cronológico. 9 - Indique suas informações de contato. 10 - Adicione suas redes sociais. 11 - Revise cuidadosamente a ortografia e a gramática antes de enviar, já que um único erro pode causar uma má impressão no recrutador. 12 - Personalize o currículo para cada vaga, destacando as palavras-chave que aparecem no anúncio do cargo." }
      ],
      vocabulary: [
        {
    ...
    },
    {
      ...
      dialogue: [
        ...
        { who: "A", es: "¡Nos alegramos! ¡Sea bienvenido! Antes de terminar, ¿tiene alguna pregunta sobre el puesto o sobre la empresa?", pt: "Ficamos felizes! Seja bem-vindo! Antes de terminar, você tem alguma pergunta sobre o cargo ou sobre a empresa?" },
        { who: "B", es: "Sí, me gustaría saber si hay posibilidades de crecimiento dentro de la empresa a mediano plazo.", pt: "Sim, eu gostaria de saber se há possibilidades de crescimento dentro da empresa a médio prazo." },
        { who: "A", es: "Claro que sí. Muchos de nuestros gerentes actuales empezaron en puestos de nivel inicial, así que las oportunidades existen para quien se esfuerza.", pt: "Claro que sim. Muitos dos nossos gerentes atuais começaram em cargos de nível inicial, então as oportunidades existem para quem se esforça." },
        { who: "B", es: "Eso me anima mucho. Estoy listo para empezar cuanto antes.", pt: "Isso me anima muito. Estou pronto para começar o quanto antes." },
        { who: "A", es: "¡Perfecto! Recursos humanos se pondrá en contacto con usted mañana con todos los detalles.", pt: "Perfeito! O RH vai entrar em contato com você amanhã com todos os detalhes." },
    ...
    },
    {
      ...
      dialogue: [
        { who: "text", es: "El calentamiento global — 12 consejos: 1. Reduce el consumo de agua. 2. Planta un árbol. 3. Educa a los más jóvenes. 4. Modera el uso del vehículo y reduce el consumo del aire acondicionado. 5. Evita usar en exceso la plancha, el calentador de agua o la lavadora. 6. Usa habitualmente papel reciclado y reduce el consumo de papel. 7. Recicla la basura. 8. No consumas animales exóticos como tortugas e iguanas, y pescado de tamaños pequeños. 9. Exige del gobierno la gestión sostenible a largo plazo de los recursos naturales. 10. Minimiza el uso de productos químicos como aerosoles, fertilizantes, etc. 11. Prioriza el transporte público, la bicicleta o caminar siempre que sea posible, en lugar de usar el coche para trayectos cortos. 12. Apoya a las empresas y auditorías que certifican buenas prácticas ambientales, como la norma ISO 14001, ya que esto incentiva a más organizaciones a cuidar el medio ambiente.", pt: "O aquecimento global — 12 dicas: 1. Reduza o consumo de água. 2. Plante uma árvore. 3. Eduque os mais jovens. 4. Modere o uso do veículo e reduza o consumo do ar-condicionado. 5. Evite usar em excesso o ferro de passar, o aquecedor de água ou a máquina de lavar. 6. Use habitualmente papel reciclado e reduza o consumo de papel. 7. Recicle o lixo. 8. Não consuma animais exóticos como tartarugas e iguanas, e peixes de tamanhos pequenos. 9. Exija do governo a gestão sustentável a longo prazo dos recursos naturais. 10. Minimize o uso de produtos químicos como aerossóis, fertilizantes, etc. 11. Priorize o transporte público, a bicicleta ou caminhar sempre que possível, em vez de usar o carro para trajetos curtos. 12. Apoie as empresas e auditorias que certificam boas práticas ambientais, como a norma ISO 14001, já que isso incentiva mais organizações a cuidarem do meio ambiente." }
      ],
      vocabulary: [
        {
    ...
    },
    {
      ...
      dialogue: [
        ...
        { who: "A", es: "¡Muchísimas gracias! Ah, una cosa más, ¿el hotel tiene servicio de gimnasio y piscina?", pt: "Muito obrigado! Ah, mais uma coisa, o hotel tem serviço de academia e piscina?" },
        { who: "B", es: "Sí, señor. Ambos están abiertos de las 6h a las 22h, en el segundo piso, y son gratuitos para los huéspedes.", pt: "Sim, senhor. Ambos ficam abertos das 6h às 22h, no segundo andar, e são gratuitos para os hóspedes." },
        { who: "A", es: "¡Excelente! Y si necesito servicio de habitación durante la noche, ¿a qué número debo llamar?", pt: "Excelente! E se eu precisar de serviço de quarto durante a noite, para qual número devo ligar?" },
        { who: "B", es: "Marque el 9 desde el teléfono de la habitación, tenemos servicio las 24 horas.", pt: "Disque 9 pelo telefone do quarto, temos serviço 24 horas." },
        { who: "A", es: "Perfecto, muchas gracias por toda la información.", pt: "Perfeito, muito obrigado por todas as informações." },
    ...
    },
    {
      ...
      dialogue: [
        { who: "text", es: "Estoy pensando en empezar a practicar algún deporte porque sé que además de hacer mejorar la capacidad física, también es bueno para el psicológico, porque la persona se siente mejor con su cuerpo y tiene la mente más despejada. El deporte no puede ser una cosa mala para tu vida, porque puede ser un pasatiempo, juego, diversión, competición y hacerte tener más disciplina. Estaba pensando en algún deporte externo y que también pueda ser practicado en el interior, como el vóleibol, pero después pensé mejor y he decidido que voy a nadar, porque la natación es buenísima para la salud y para todo lo demás. Estoy muy ansiosa para empezar. Si tuviera tiempo, empezaría hoy mismo, pero creo que empezaré el próximo mes pues estaré trabajando un tercio del tiempo que estoy trabajando en este momento. Ya investigué varias piscinas cerca de mi casa y encontré una que tiene clases para principiantes los martes y jueves por la tarde, justo el horario que me viene mejor. También compré ya un bañador nuevo, gafas de natación y un gorro, así que solo me falta empezar de verdad. Después les cuento más novedades.", pt: "Estou pensando em começar a praticar algum esporte porque sei que, além de melhorar a capacidade física, também é bom para o psicológico, porque a pessoa se sente melhor com o corpo e tem a mente mais tranquila. O esporte não pode ser uma coisa ruim para a sua vida, porque pode ser um passatempo, jogo, diversão, competição e te fazer ter mais disciplina. Eu estava pensando em algum esporte externo que também pudesse ser praticado dentro de casa, como o vôlei, mas depois pensei melhor e decidi que vou nadar, porque a natação é ótima para a saúde e para tudo mais. Estou muito ansiosa para começar. Se eu tivesse tempo, começaria hoje mesmo, mas acho que vou começar no próximo mês, pois estarei trabalhando um terço do tempo que estou trabalhando neste momento. Já pesquisei várias piscinas perto de casa e encontrei uma que tem aulas para iniciantes às terças e quintas à tarde, justamente o horário que fica melhor para mim. Também já comprei um maiô novo, óculos de natação e uma touca, então só falta começar de verdade. Depois conto mais novidades." }
      ],
      vocabulary: [
        {
          category: "Deportes",
    ...
    },
    {
      ...
      dialogue: [
        ...
        { who: "A", es: "¡Qué fácil! ¡Muchísimas gracias! Una última pregunta, ¿sabe si la tienda de herramientas acepta tarjeta de crédito?", pt: "Que fácil! Muito obrigada! Uma última pergunta, você sabe se a loja de ferramentas aceita cartão de crédito?" },
        { who: "B", es: "Creo que sí, pero le recomiendo llevar algo de efectivo también, por si acaso.", pt: "Acho que sim, mas recomendo levar algum dinheiro também, só por precaução." },
        { who: "A", es: "Buena idea, voy a pasar por el cajero antes. ¡Muchas gracias de nuevo!", pt: "Boa ideia, vou passar no caixa eletrônico antes. Muito obrigada de novo!" },
    ...
    },
    {
      ...
      dialogue: [
        ...
        { who: "A", es: "Vale, y avísame también qué le llevamos a Priscila. No podemos llegar con las manos vacías.", pt: "Combinado, e me avisa também o que a gente leva para a Priscila. Não podemos chegar de mãos vazias." },
        { who: "B", es: "Es verdad. Podríamos llevar unas botellas de vino y algún postre. Yo pregunto qué le gusta más.", pt: "É verdade. A gente podia levar umas garrafas de vinho e alguma sobremesa. Eu pergunto o que ela gosta mais." },
        { who: "A", es: "Perfecto, quedamos así entonces. ¡Hablamos más tarde!", pt: "Perfeito, combinado então. A gente se fala mais tarde!" },
        { who: "B", es: "Bueno, ¡hasta luego!", pt: "Certo, até mais!" }
      ],
      vocabulary: [
        {
