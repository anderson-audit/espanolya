...
const LEVEL_PROFESIONAL = {
  ...
  lessons: [
    ...
    },
    {
      ...
      text: "Un certificado ISO/IEC 27001 real, emitido a una organización certificada, dice así: 'Certifica que el Sistema de Gestión de la organización ha sido auditado y aprobado con respecto a los requisitos especificados en ISO/IEC 27001:2022. Este certificado es aplicable al siguiente alcance: seguridad de la información de los sistemas críticos del negocio, según la Declaración de Aplicabilidad versión 01.' Observa los datos que siempre aparecen en un certificado real: el alcance exacto (nunca dice solo 'toda la empresa', sino los sistemas específicos cubiertos), la fecha de otorgamiento y la fecha de vencimiento del ciclo actual (normalmente 3 años, con auditorías de seguimiento en el medio), y la advertencia final: 'Esta aprobación está sujeta a que el sistema de gestión se mantenga de acuerdo con los requisitos especificados, lo cual será verificado por el organismo de certificación.' Es común que la organización reciba, además, un segundo certificado equivalente emitido por una red internacional de organismos de certificación, confirmando en inglés que la empresa 'has implemented and maintains an Information Security Management System' para el mismo alcance.",
      textPt: "Um certificado ISO/IEC 27001 real, emitido a uma organização certificada, diz assim: 'Certifica que o Sistema de Gestão da organização foi auditado e aprovado em relação aos requisitos especificados na ISO/IEC 27001:2022. Este certificado é aplicável ao seguinte escopo: segurança da informação dos sistemas críticos do negócio, conforme a Declaração de Aplicabilidade versão 01.' Observe os dados que sempre aparecem em um certificado real: o escopo exato (nunca diz apenas 'toda a empresa', mas sim os sistemas específicos cobertos), a data de outorga e a data de vencimento do ciclo atual (normalmente 3 anos, com auditorias de acompanhamento no meio do caminho), e o aviso final: 'Esta aprovação está sujeita à manutenção do sistema de gestão de acordo com os requisitos especificados, o que será verificado pelo organismo de certificação.' É comum que a organização receba, além disso, um segundo certificado equivalente emitido por uma rede internacional de organismos de certificação, confirmando em inglês que a empresa 'implementou e mantém um Sistema de Gestão de Segurança da Informação' para o mesmo escopo.",
      exercises: [
        ...
        { type: "mc", q: "Además del organismo certificador principal, ¿quién puede emitir un certificado equivalente reconocido internacionalmente?", options: ["Una red internacional de organismos de certificación", "La OMS", "El Banco Mundial", "La ONU"], correct: 0 }
      ]
    },
    {
      id: "p6",
